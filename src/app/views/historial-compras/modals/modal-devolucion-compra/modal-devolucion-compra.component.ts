...
@Component({
  selector: 'app-modal-devolucion-compra',
  templateUrl: './modal-devolucion-compra.component.html',
  styleUrls: ['./modal-devolucion-compra.component.scss']
})
export class ModalDevolucionCompraComponent implements OnInit {
  ...
  submit() {
    ...
    if(this.form.controls["cantidad"].value > 0){
      ...
      this.historialComprasService.createDevolucionInventario(
